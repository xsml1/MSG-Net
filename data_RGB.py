import os
from dataset_RGB import DataLoaderTrain, DataLoaderVal, DataLoaderTest, DataLoaderTestNR #, DataLoaderTest2
...
def get_test_nr_data(rgb_dir, img_options, image_size):
    assert os.path.exists(rgb_dir)
    return DataLoaderTestNR(rgb_dir, img_options, image_size)
